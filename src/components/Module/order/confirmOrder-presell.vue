                    ...
                    <div class="goods-item">
                        ...
                        <div class="goods-main">
                            <div class="m-col" v-for="(itm,idx) in item.createOrderDtoList" :key="idx">
                                ...
                                <div class="col-price">¥{{itm.goods.salePrice}}</div>
                            ...
                            <div class="m-note">
                                <div class="note-content">
                                    <div class="p">备注：</div>
                                    <input  placeholder="在此输入备注,限50字符(选填）" class="input" v-model="item.remark"/>
                                    <div class="text">
                                        店铺合计
    ...
    methods:{
                ...
                if (data.code == "0000") {
                    ...
                    if(data.coupons.length) {
                        ...
                        let item = data.coupons[0]
                         this.changeSelect(data.coupons[0]);
        ...
        payTap(){
            ...
            this.$post('/user/submitOrder.do',Arr).then(({data})=>{
                ...
                if(data.code == '1004' && data.msg == '当前优惠券不可用'){
